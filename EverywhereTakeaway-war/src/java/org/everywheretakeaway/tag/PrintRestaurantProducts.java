 ...
 * @author Fede
 */
public class PrintRestaurantProducts extends SimpleTagSupport {
    ...
    public void doTag() throws JspException,IOException {
        ...
        while(iterator.hasNext()) {
            ...
            out.println("<br/><div style=\"text-align:right;\"><a href=\"update_product.action?product_id=" + current.getId() + "\">Modifica</a> / <a href=\"delete_product.action?product_id=" + current.getId() + "\">Elimina</a></div>");
